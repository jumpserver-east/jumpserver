...
CAMERA_SYSTEM_BASE_URL = CONFIG.CAMERA_SYSTEM_BASE_URL
CAMERA_SYSTEM_SIGN_DATA = CONFIG.CAMERA_SYSTEM_SIGN_DATA
CAMERA_TOKEN_CACHE_SECONDS = CONFIG.CAMERA_TOKEN_CACHE_SECONDS
CAMERA_PHOTO_TIMEOUT_SECONDS = CONFIG.CAMERA_PHOTO_TIMEOUT_SECONDS
AI_FACE_BASE_URL = CONFIG.AI_FACE_BASE_URL
AI_FACE_APP_ID = CONFIG.AI_FACE_APP_ID
AI_FACE_SIGN_KEY = CONFIG.AI_FACE_SIGN_KEY
AI_FACE_SM4_KEY = CONFIG.AI_FACE_SM4_KEY
AI_FACE_AGENT_ID = CONFIG.AI_FACE_AGENT_ID
AI_FACE_ACCESS_TOKEN = CONFIG.AI_FACE_ACCESS_TOKEN
AI_FACE_TOKEN_CACHE_SECONDS = CONFIG.AI_FACE_TOKEN_CACHE_SECONDS
AI_FACE_PASS_THRESHOLD = CONFIG.AI_FACE_PASS_THRESHOLD
