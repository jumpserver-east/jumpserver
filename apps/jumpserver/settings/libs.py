...
# GM DEVICE
GM_VENDOR_NAME = CONFIG.GM_VENDOR_NAME or 'piico'
GM_DEVICE_ENABLE = CONFIG.GM_DEVICE_ENABLE
PIICO_DEVICE_ENABLE = CONFIG.PIICO_DEVICE_ENABLE
if GM_DEVICE_ENABLE is None:
    GM_DEVICE_ENABLE = PIICO_DEVICE_ENABLE
if PIICO_DEVICE_ENABLE is None:
    PIICO_DEVICE_ENABLE = bool(
        GM_DEVICE_ENABLE and GM_VENDOR_NAME.lower() == 'piico'
    )

PIICO_DRIVER_PATH = CONFIG.PIICO_DRIVER_PATH
GM_DRIVER_PATH = CONFIG.GM_DRIVER_PATH or PIICO_DRIVER_PATH
if not PIICO_DRIVER_PATH and GM_VENDOR_NAME.lower() == 'piico':
    PIICO_DRIVER_PATH = GM_DRIVER_PATH
